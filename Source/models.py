""" The ML models collection. They are copied from the PyTorch examples and some are from the literature. """
import torch
...
class VGG16Wrapper(models.VGG):
    def __init__(self):
        super().__init__(self.make_layers([64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 512, 512, 512, 'M', 512, 512, 512, 'M']))
...
class SqueezeNetWrapper(models.SqueezeNet):
    def __init__(self):
...
"""Some Models from the literature"""
